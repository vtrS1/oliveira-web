  ...
  methods: {
    ...
    changePosition(elxEvent, tooltip) {
      ...
      let leftx =
        ...
        (tooltip != undefined ? tooltip.clientWidth : 0) / 2 +
        elx.clientWidth / 2;
      ...
      if (this.position == "bottom") {
        ...
        leftx =
          elx.getBoundingClientRect().left -
          (tooltip != undefined ? tooltip.clientWidth : 0) -
          4;
        topx =
        ...
        leftx =
          elx.getBoundingClientRect().left +
          (elx != undefined ? elx.clientWidth : 0) +
          4;
        topx =
          elx.getBoundingClientRect().top +
          scrollTopx +
        ...
        if (
          window.innerWidth -
            (leftx + (tooltip != undefined ? tooltip.clientWidth : 0)) <=
          20
        ) {
          leftx =
            elx.getBoundingClientRect().left -
