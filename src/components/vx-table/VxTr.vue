<template>
  ...
  >
    ...
    >
      ...
      <vs-icon v-if="$slots.expand" @click="expand_click"
        >keyboard_arrow_down</vs-icon
      >
    </td>
    <slot></slot>
  </tr>
...
<script>
import Vue from "vue";
import VxTrExpand from "./VxTrExpand.vue";
export default {
  name: "VxTr",
  props: {
    state: {
